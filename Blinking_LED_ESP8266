...
you can modify it according to your application
unsigned int led1 = 1;
//unsigned int led2 = 2;
//unsigned int led3 = 3;
WiFiClient client;
...
void loop() {
 ...
 int led_1 = ThingSpeak.readFloatField(channel, 
led1);
 //int led_2 = ThingSpeak.readFloatField(channel, 
led2);
 //int led_3 = ThingSpeak.readFloatField(channel, 
led3);
 if(led_1 == 1){
 digitalWrite(D1, 1);
